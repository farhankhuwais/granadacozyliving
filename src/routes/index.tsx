...
import { TrendingUp, Activity, BedDouble, CreditCard, Wrench } from "lucide-react";
...
export default function InvestorDashboardPage() {
  ...
  const activities = [
    { icon: BedDouble, text: `${stats.occupiedRooms}/${stats.totalRooms} kamar terisi`, time: "Saat ini", color: "bg-success/10 text-success" },
    { icon: CreditCard, text: `Pendapatan: ${formatRupiah(stats.totalIncome)}`, time: "Bulan ini", color: "bg-primary/10 text-primary" },
    { icon: Wrench, text: `${stats.activeRequestCount} permintaan aktif`, time: "Saat ini", color: "bg-gold/10 text-gold" },
  ];
  ...
  return (
    <MobileLayout>
      <div className="px-5 pt-12 pb-6">
        <div className="mb-6">
          <h1 className="text-xl font-bold text-foreground">Ringkasan Investasi</h1>
        ...
        <div className="mb-5 grid grid-cols-2 gap-3">
          <StatCard
            ...
            sub={`Sewa: ${formatRupiah(stats.monthlyRent)} + Harian: ${formatRupiah(stats.dailyRent)}`}
          />
          <StatCard
